...
{
    public class Leafs : BaseParticle
    {
        ...
        public Leafs(Vector2 position, Vector2 velocity, Color color, int lifetime, float Rot, float opacity, float scale, float speed)
        {
            Position = position;
            Velocity = velocity;
            DrawColor = color;
